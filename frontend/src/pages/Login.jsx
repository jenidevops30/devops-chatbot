    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-5">
      <div className="max-w-md w-full bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-2xl">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-gray-400 font-mono">Login to your account</p>
        </div>
        ...
        <p className="text-center mt-8 text-sm text-gray-500 font-mono">
          ...
          <Link to="/register" className="text-blue-500 hover:text-blue-400 font-semibold no-underline">
            Register for free
          </Link>
        </p>
      </div>
